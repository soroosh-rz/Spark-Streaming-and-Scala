object LearningScala3 {
  ...
  transformInt(9, x => x / 2)                     //> res1: Int = 4
  ...
  def convertString(s: String) : String = {
  	s.toUpperCase()
  }                                               //> convertString: (s: String)String
  
  def makeUpperCase(s: String, f: String => String) : String = {
  	f(s)
  }                                               //> makeUpperCase: (s: String, f: String => String)String
  
  makeUpperCase("fooo", convertString)            //> res3: String = FOOO
  makeUpperCase("Hello", x => x.toUpperCase)      //> res4: String = HELLO
